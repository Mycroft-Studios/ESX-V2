...
Citizen.CreateThread(function()
	...
	module.RequestAllIpls()

  for k,ipl in pairs(module.Config.allIpls) do
		module.loadInterior(ipl.coords, ipl.interiorsProps, ipl.interiorsPropColors)
	end
end)

module.loadInterior = function(coords, interiorProps, interiorsPropColors)
...
module.RequestAllIpls() = function()
